        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-green">
              <div class="inner">
                ...
                <p class="font-weight-bold">{{ __("incoming goods report") }}</p>
              </div>
              <div class="icon">
                <i class="fas fa-file-alt"></i>

              </div>
              <a href="{{route('laporan.masuk')}}" class="small-box-footer">{{ __('messages.more-info') }} <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          @endif
          @endif
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-red">
              <div class="inner">
                ...
                <p class="font-weight-bold">{{ __("outgoing goods report") }}</p>
              </div>
              <div class="icon">
                <i class="fas fa-file-alt"></i>
              </div>
              <a href="{{route('laporan.keluar')}}" class="small-box-footer">{{ __('messages.more-info') }} <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          @endif
          @endif
