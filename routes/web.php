...
Route::middleware(['auth', "localization"])-> group(function(){
    ...
    Route::controller(TransactionInController::class)->prefix('/transaksi/masuk')->group(function(){
        ...
        Route::post('/simpan','save')->name('transaksi.masuk.save');
        Route::post('/info','detail')->name('transaksi.masuk.detail');
        Route::put('/ubah','update')->name('transaksi.masuk.update');
        Route::delete('/hapus','delete')->name('transaksi.masuk.delete');
    ...
    // pengaturan pengguna
    Route::middleware(['staff.middleware'])->group(function(){
        Route::controller(staffController::class)->prefix('/settings/staff')->group(function(){
            Route::get('/','index')->name('settings.staff');
